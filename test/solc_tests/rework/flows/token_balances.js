...
describe("ReversibleICO - Withdraw Token Balance", function () {
    ...
    describe("token lock and unlock amount tests - branch 1 - no returns", async function () {
        ...
        it("3 - Jump to stage 2 block 1 (10%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 2, false);
        });
        ...
        it("4 - Jump to stage 4 block 1 (30%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 4, false);
        });
        ...
        it("4 - Jump to stage 9 block 1 (80%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 9, false);
        });
    ...
    describe("token lock and unlock amount tests - branch 2 - return half in stage 0", async function () {
        ...
        it("4 - Jump to stage 2 block 1 (10%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 2, false);
        });
        ...
        it("5 - Jump to stage 4 block 1 (30%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 4, false);
        });
        ...
        it("6 - Jump to stage 9 block 1 (80%)", async function () {
    ...
    describe("token lock and unlock amount tests - branch 4 - return 60 of 100 in stage 1", async function () {
        ...
        it("3 - Jump to stage 3 block 1 (20%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 3, false);
        });
    ...
    describe("token lock and unlock amount tests - branch 6 - return all tokens in stage 2 - buy more in 4 - check balances in 6-8", async function () {
        ...
        it("6 - Buy 3 tokens in stage 5", async function () {
            const stageId = 5;
            await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, stageId, false);
            ...
            // console.log('DEBUG2 ', await this.ReversibleICO.methods.DEBUG2().call());
            // console.log('DEBUG3 ', await this.ReversibleICO.methods.DEBUG3().call());
            // console.log('DEBUG4 ', await this.ReversibleICO.methods.DEBUG4().call());
            // console.log('ContributionAmount ', priceInStage(stageId));
        ...
        it("Expect unlocked tokens to be 1.5 tokens - 0.3 + 1.2 40% of bought", async function () {
            const balance = await TokenContractInstance.methods.getUnlockedBalance(TestParticipant).call();
            expect(balance).to.be.equal("1500000000000000000");
        });

        it("7 - Jump to stage 7 block 1 (60%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 7, false);
        });
        ...
        it("Expect unlocked tokens to be 2.1 tokens - 0.3 + 1.8 60% of bought", async function () {
            const balance = await TokenContractInstance.methods.getUnlockedBalance(TestParticipant).call();
            expect(balance).to.be.equal("2100000000000000000");
        });

        it("8 - Jump to stage 9 block 1 (80%)", async function () {
            currentBlock = await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, 9, false);
        });
        ...
        it("Expect unlocked tokens to be 2.7 tokens - 0.3 + 2.4 80% of bought", async function () {
            const balance = await TokenContractInstance.methods.getUnlockedBalance(TestParticipant).call();
    ...
    describe("token lock and unlock amount tests - branch 7 - return all tokens in stage 2 - buy more in 4 - force allocation in 6", async function () {
        ...
        it("6 - Buy 3 tokens in stage 5 block 1 (40%)", async function () {
            const stageId = 5;
            await helpers.utils.jumpToContractStage(this.ReversibleICO, deployerAddress, stageId, false);
    ...
    describe("token lock and unlock amount tests - branch 8 - return all tokens in stage 2 - buy more in 4 - return in 6", async function () {
        ...
        it("Expect unlocked tokens TO REMAIN THE SAME - 2.1 tokens", async function () {
            const balance = await TokenContractInstance.methods.getUnlockedBalance(TestParticipant).call();
            expect(balance).to.be.equal("2100000000000000000");
        });
        ...
        it("Expect locked tokens to be 0.55 tokens", async function () {
            const locked = await this.ReversibleICO.methods.getReservedTokenAmount(TestParticipant).call();
            expect(locked).to.be.equal("550000000000000000");
        });

        it("Expect unlocked tokens to be 2.65 tokens - 0.3 + 1.8 + 0.55 ", async function () {
            const balance = await TokenContractInstance.methods.getUnlockedBalance(TestParticipant).call();
            expect(balance).to.be.equal("2650000000000000000");
        });
